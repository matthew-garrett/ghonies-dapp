...
const Faq = () => {
  return (
    <>
      <FaqWrapper id="faq">
        ...
        <AccordionWrapper>
          ...
          <AccordionDetails>
            ...
            >
              ...
              of an ancient, cosmic pastry tribe which sparked the
              interplanetary evolution that gave rise to modern day earthly
              donuts. Without Ghonies, Earth as we know it would exist
              perpetually in a state of demented and desparate hunger for
              culinary joy.
            </Typography>
          </AccordionDetails>
        </AccordionWrapper>
        <AccordionWrapper>
          ...
          <AccordionDetails>
            ...
            >
              Interact with our tweets and on Discord to get on the whitelist.
              The whitelist and public mint will happen on our site. After those
              events, Ghonies will be available on secondary market platforms
        ...
        <AccordionWrapper>
          ...
          <AccordionDetails>
            ...
            >
              Art: Our mid-century trash pop art style is not only timeless, but
              a fresh evolution in NFT art. We designed something that would be
              as enchanting in a living room as it is on the street or in a
              gallery, and of course as a profile picture.
              <br />
              <br />
        ...
        <AccordionWrapper>
          ...
          <AccordionDetails>
            ...
            >
              ...
              code. An NFT is the digital asset itself but also the assets
              history from its origin to your wallet, verified on the blockchain
              forever. It’s proof of ownership, provenance, and membership. Your
              provably unique NFT grants you privileged access to a community
              and its events, merch, drops and much more. This concept is in its
              infancy so the potential is limitless
            </Typography>
          </AccordionDetails>
        </AccordionWrapper>
        <AccordionWrapper>
      ...
      >
        <WhitePaperImage src={whitepaperLogo} atl="whitepaper" />
      </WhitePaperLink>
    </>
  );
};
